...
def stack_operations():
    ...
    cprint("Welcome to the interactive Stack Operations Program!",
           "cyan", attrs=["bold"])
    cprint("You can perform the following operations on the stack:",
           "cyan")

    while True:
        print("\nCurrent stack:", colored(str(stk), "blue"))
        ...
        if choice == 1:
            ...
            try:
                cprint("Top item: " + stk.peek(), "blue")
            except IndexError as e:
                cprint(e, "red")

        elif choice == 4:
            cprint("Is the stack empty? " +
                   ("Yes" if stk.is_empty() else "No"), "blue")

        elif choice == 5:
            cprint("Size of the stack: " + str(stk.size()), "blue")

        elif choice == 6:
            cprint("Exiting the program. Goodbye!",
                   "cyan", attrs=["bold"])
            break
